...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	// {
	// 	name: "[Gen 9] National Dex Sideshow Unc Cup ",
	// 	gameType: 'doubles',
	// 	searchShow: false,
	// 	bestOfDefault: true,
	// 	mod: 'gen9uncvgc',
    ...
    //         return [`${set.name || set.species}'s item ${item.name} is not available in Gen 9.`];
    //     		}
	// 		}
	// 	}
	// },
	...
	// },
	{
		...
		bestOfDefault: true,
		mod: 'gen9uncvgc',
		ruleset: ['Obtainable', 'Team Preview', 'Species Clause', 'Nickname Clause','NatDex Mod','HP Percentage Mod', 'Cancel Mod', 'Terastal Clause','Picked Team Size = Auto', 'VGC Timer', 'Force Open Team Sheets', 'Limit One Restricted', 'Mega Rayquaza Clause','Item Clause = 1','Adjust Level = 50' ],
		restricted: ['Restricted Legendary'],
		banlist: ['Kyogre-Primal', 'Groudon-Primal', 'Mythical','Greninja-Bond','Rayquaza-Mega', 'Dialga-Origin','Palkia-Origin'],
		onValidateSet(set, format, setHas, teamHas) {
			for (const moveid of set.moves) {
	...
	},
	{
		...
		ruleset: ['[Gen 9] LC'],
		banlist: [
			'Chinchou', 'Diglett-Alola', 'Drifloon', 'Elekid', 'Foongus', 'Glimmet', 'Gothita', 'Greavard', 'Grookey', 'Growlithe-Hisui', 'Koffing', 'Mareanie',
			'Mienfoo', 'Mudbray', 'Pawniard', 'Salandit', 'Sandshrew-Alola', 'Shellder', 'Shellos', 'Snover', 'Stunky', 'Timburr', 'Tinkatink', 'Toedscool',
	...
	},
	{
		...
		banlist: [
			...
			'Chien-Pao', 'Comfey', 'Darmanitan', 'Darmanitan-Galar', 'Darmanitan-Galar-Zen', 'Deoxys-Normal', 'Deoxys-Attack', 'Dialga', 'Dondozo', 'Enamorus',
	...
	},
	{
		...
		bestOfDefault: true,
		mod: 'gen5vgc',
		ruleset: ['Terastal Clause','Flat Rules', '!! Adjust Level = 50', 'VGC Timer', 'Open Team Sheets', 'Limit One Restricted'],
		restricted: ['Restricted Legendary'],
		banlist: ['Kyogre-Primal', 'Groudon-Primal'],
		onValidateSet(set, format, setHas, teamHas) {
			if (set.item) {
				const item = this.dex.items.get(set.item);
				if (item.megaStone && !(this.ruleTable.has(`+item:${item.id}`) || this.ruleTable.has(`+pokemontag:mega`))) {
